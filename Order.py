...
#         order_time = f' Время заказа: {self.order_creation_time}'
#         ready_time = f' Время готовности: {self.order_creation_time + self.preparation_time if self.readiness is False else "Ваш заказ готов."}'
#         print(f'|{" " * self.len_card}|\n'
#               f'|{order_time}{" " * dist(order_time)}|\n'
#               f'|{ready_time}{" " * dist(ready_time)}|')
#
#         print(f'+{"-" * self.len_card}+')
...
# # print(x.add_datetime())
# x.add_amount()
# x.show_orders()
# x.find_preparation_time()
# print(x.readiness)

# empty_time = datetime.timedelta()
# minutes_30 = datetime.timedelta(minutes=30)
# sum = datetime.datetime.now() + minutes_30
#
# print(empty_time)
# print(minutes_30)
# print(minutes_30 > empty_time)
# print(sum + minutes_30)
#
# times = [datetime.timedelta(minutes=30), datetime.timedelta(minutes=55), datetime.timedelta(minutes=20)]
# print(max(times))
...
class Order:
    ...
    def show_orders(self):  # метод подсчета количества каждой заказанной пиццы
        ...
        total_price_string = f' Сумма: {self.total_price}'
        print(f'|{" " * self.len_card}|\n'
